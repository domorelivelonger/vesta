...
echo "Run php -v and ask on forum or vesta@webxdata.com"
...
ln -s /usr/local/vesta/data/templates/web/httpd/phpfcgid.tpl /usr/local/vesta/data/templates/web/httpd/php70.tpl  

ln -s /etc/opt/remi/php70/php.ini /etc/php70.ini

ln -s  /etc/opt/remi/php70/php.d /etc/php70.d

chmod +x /usr/local/vesta/data/templates/web/httpd/php70.sh
tput setaf 1
echo "PHP 7.0 Ready!"
tput sgr0 
fi
...
ln -s /usr/local/vesta/data/templates/web/httpd/phpfcgid.tpl /usr/local/vesta/data/templates/web/httpd/php71.tpl  

ln -s /etc/opt/remi/php71/php.ini /etc/php71.ini

ln -s  /etc/opt/remi/php71/php.d /etc/php71.d

chmod +x /usr/local/vesta/data/templates/web/httpd/php71.sh
tput setaf 1
echo "PHP 7.1 Ready!"
tput sgr0 
fi
...
ln -s /usr/local/vesta/data/templates/web/httpd/phpfcgid.tpl /usr/local/vesta/data/templates/web/httpd/php72.tpl  

ln -s /etc/opt/remi/php72/php.ini /etc/php72.ini

ln -s  /etc/opt/remi/php72/php.d /etc/php72.d

chmod +x /usr/local/vesta/data/templates/web/httpd/php72.sh
tput setaf 1
echo "PHP 7.2 Ready!"
tput sgr0 
fi
...
ln -s /usr/local/vesta/data/templates/web/httpd/phpfcgid.tpl /usr/local/vesta/data/templates/web/httpd/php56.tpl 

ln -s /etc/opt/remi/php56/php.ini /etc/php56.ini

ln -s  /etc/opt/remi/php56/php.d /etc/php56.d

chmod +x /usr/local/vesta/data/templates/web/httpd/php56.sh
...
ln -s /usr/local/vesta/data/templates/web/httpd/phpfcgid.tpl /usr/local/vesta/data/templates/web/httpd/php55.tpl 

ln -s /etc/opt/remi/php55/php.ini /etc/php55.ini

ln -s  /etc/opt/remi/php55/php.d /etc/php55.d

chmod +x /usr/local/vesta/data/templates/web/httpd/php55.sh
...
ln -s /usr/local/vesta/data/templates/web/httpd/phpfcgid.tpl  /usr/local/vesta/data/templates/web/httpd/php54.tpl  
...
chmod +x /usr/local/vesta/data/templates/web/httpd/php54.sh
tput setaf 1
echo "PHP 5.4 Ready!"
tput sgr0
fi
...
sed -i 's/; max_input_vars = 10000/max_input_vars = 10000/' /etc/php.ini
...
sed -i 's/max_execution_time = 30/max_execution_time = 120/' /opt/remi/php55/root/etc/php.ini
sed -i 's/max_input_time = 60/max_input_time = 120/' /opt/remi/php55/root/etc/php.ini
sed -i 's/; max_input_vars = 10000/max_input_vars = 10000/' /opt/remi/php55/root/etc/php.ini
sed -i 's/max_input_vars = 1000/max_input_vars = 10000/' /opt/remi/php55/root/etc/php.ini
sed -i 's/max_file_uploads = 20/max_file_uploads = 200/' /opt/remi/php55/root/etc/php.ini
...
sed -i 's/max_execution_time = 30/max_execution_time = 120/' /opt/remi/php54/root/etc/php.ini
sed -i 's/max_input_time = 60/max_input_time = 120/' /opt/remi/php54/root/etc/php.ini
sed -i 's/; max_input_vars = 10000/max_input_vars = 10000/' /opt/remi/php54/root/etc/php.ini
sed -i 's/max_input_vars = 1000/max_input_vars = 10000/' /opt/remi/php54/root/etc/php.ini
sed -i 's/max_file_uploads = 20/max_file_uploads = 200/' /opt/remi/php54/root/etc/php.ini
...
sed -i 's/max_execution_time = 30/max_execution_time = 120/' /etc/opt/remi/php70/php.ini
sed -i 's/max_input_time = 60/max_input_time = 120/' /etc/opt/remi/php70/php.ini
sed -i 's/; max_input_vars = 10000/max_input_vars = 10000/' /etc/opt/remi/php70/php.ini
sed -i 's/max_input_vars = 1000/max_input_vars = 10000/' /etc/opt/remi/php70/php.ini
sed -i 's/max_file_uploads = 20/max_file_uploads = 200/' /etc/opt/remi/php70/php.ini
...
sed -i 's/max_execution_time = 30/max_execution_time = 120/' /etc/opt/remi/php72/php.ini
sed -i 's/max_input_time = 60/max_input_time = 120/' /etc/opt/remi/php72/php.ini
sed -i 's/; max_input_vars = 10000/max_input_vars = 10000/' /etc/opt/remi/php72/php.ini
